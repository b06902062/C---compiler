...
assign_expr_list : nonempty_assign_expr_list 
                     {
                        /*TODO*/
                         $$ = makeChild(
                            Allocate(NONEMPTY_ASSIGN_EXPR_LIST_NODE), $1
                         );
                     }
                 |  
                     {
...
relop_expr_list	: nonempty_relop_expr_list 
                    {
                        /*TODO*/
                        $$ = makeChild(
                            Allocate(NONEMPTY_RELOP_EXPR_LIST_NODE), $1
                        );
                    }
                | 
                    {
