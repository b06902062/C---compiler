...
int g_func_param_cnt = 0; // [msg] trick, should work for func param
...
void declareIdList(AST_NODE* declarationNode, SymbolAttributeKind isVariableOrTypeAttribute, int ignoreArrayFirstDimSize)
{
    ...
    while(traverseIDList)
    {
        ...
        else
        {
            ...
            if ( declarationNode->semantic_value.declSemanticValue.kind == FUNCTION_PARAMETER_DECL)
            traverseIDList->semantic_value.identifierSemanticValue.symbolTableEntry->offset =\
                -g_func_param_cnt; // [msg] trick, should work for func param decl
        }
