...
void genExpr(char *reg, AST_NODE *exprNode) {
    ...
    if ( exprNode->semantic_value.exprSemanticValue.kind == BINARY_OPERATION ) {
        ...
        printf("[data types] L: %d, R: %d\n", exprNode->child->dataType, exprNode->child->rightSibling->dataType);
        AST_NODE *left_node = exprNode->child;
        genExprRelated(reg, left_node);
        ...
        if ( left_node->dataType == INT_TYPE && right_node->dataType == INT_TYPE ) {
            ...
            switch (exprNode->semantic_value.exprSemanticValue.op.binaryOp) {
                ...
                case BINARY_OP_DIV:
                    ...
                    break;
                case BINARY_OP_EQ:
                    genIntCompareOp(reg, reg_right, "eq");
                    break;
                case BINARY_OP_GE:
                    genIntCompareOp(reg, reg_right, "ge");
                    break;
                case BINARY_OP_LE:
                    genIntCompareOp(reg, reg_right, "le");
                    break;
                case BINARY_OP_NE:
                    genIntCompareOp(reg, reg_right, "ne");
                    break;
                case BINARY_OP_GT:
                    genIntCompareOp(reg, reg_right, "gt");
                    break;
                case BINARY_OP_LT:
                    genIntCompareOp(reg, reg_right, "lt");
                    break;
                case BINARY_OP_AND:
                    genIntLogicalOp(reg, reg_right, "and");
                    break;
                case BINARY_OP_OR:
                    genIntLogicalOp(reg, reg_right, "or");
                    break;
            }
        } 
            ...
            switch (exprNode->semantic_value.exprSemanticValue.op.binaryOp) {
                ...
                case BINARY_OP_DIV:
                    ...
                    break;
                case BINARY_OP_EQ:
                    genFloatCompareOp(reg, reg_right, "eq");
                    break;
                case BINARY_OP_GE:
                    genFloatCompareOp(reg, reg_right, "ge");
                    break;
                case BINARY_OP_LE:
                    genFloatCompareOp(reg, reg_right, "le");
                    break;
                case BINARY_OP_NE:
                    genFloatCompareOp(reg, reg_right, "ne");
                    break;
                case BINARY_OP_GT:
                    genFloatCompareOp(reg, reg_right, "gt");
                    break;
                case BINARY_OP_LT:
                    genFloatCompareOp(reg, reg_right, "lt");
                    break;
                case BINARY_OP_AND:
                    genFloatLogicalOp(reg, reg_right, "and");
                    break;
                case BINARY_OP_OR:
                    genFloatLogicalOp(reg, reg_right, "or");
                    break;
            }
        }
        free_reg(reg_right);
...
void genExprRelated(char *reg, AST_NODE *exprRelatedNode){
    switch(exprRelatedNode->nodeType){
        ...
        case IDENTIFIER_NODE:
            ...
            else {  // [msg] array case (support single dimension only)
